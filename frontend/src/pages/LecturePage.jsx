...
//   const { classId } = useParams(); // this is actually slug
...
//       try {
//         const res = await fetch(`http://localhost:5000/api/classes/${classId}/lectures`);
...
//   if (loading) return <p className="text-gray-600">Loading lectures...</p>;
...
//               <li key={lecture._id}>
//                 <Link
//                   to={`/lectures/${classId}/${lecture._id}`}
//                   className="block p-4 border rounded-lg hover:bg-gray-50 transition"
//                 >
//                   <h3 className="font-semibold">{lecture.title}</h3>
//                   <p className="text-sm text-gray-500">📅 {new Date(lecture.date).toDateString()}</p>
//                 </Link>
//               </li>
//             ))}
//           </ul>
